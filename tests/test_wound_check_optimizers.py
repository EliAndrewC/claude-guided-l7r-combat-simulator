...
from simulation.events import LightWoundsDamageEvent, WoundCheckDeclaredEvent
from simulation.groups import Group
from simulation.log import logger
from simulation.optimizers.wound_check_optimizers import DefaultKeepLightWoundsOptimizer, DefaultWoundCheckOptimizer
...
class TestRiskyKeepLightWoundsOptimizer(unittest.TestCase):
    def test_six_water(self):
        ...
        [Group("subject", character), Group("Zombies", attacker)]

...
from simulation.modifier_listeners import ExpireAfterNextAttackByCharacterListener, ExpireAfterNextAttackListener, ExpireAfterNextDamageByCharacterListener
...
class TestExpireAfterNextAttackListener(unittest.TestCase):
    ...
    def test_expire_after_failed_attack(self):
        ...
        kakita_attack = actions.AttackAction(self.kakita, self.matsu, "attack", self.initiative_action, self.context)
    ...
    def test_do_not_expire_after_irrelevant_attack(self):
        ...
        matsu_attack = actions.AttackAction(self.matsu, self.shiba, "attack", self.initiative_action, self.context)
...
class TestExpireAfterNextAttackByCharacterListener(unittest.TestCase):
    ...
    def test_do_not_expire_after_attack_by_other_character(self):
        ...
        shiba_attack = actions.AttackAction(self.shiba, self.matsu, "attack", self.initiative_action, self.context)

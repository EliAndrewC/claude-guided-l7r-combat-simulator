...
from simulation.strategies.base import BaseAttackStrategy, PlainAttackStrategy, KeepLightWoundsStrategy, NeverParryStrategy, ReluctantParryStrategy, WoundCheckStrategy

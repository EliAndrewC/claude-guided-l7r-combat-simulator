...
from simulation.events import AddModifierEvent, AttackSucceededEvent
...
class TestWaveManAttackAction(unittest.TestCase):
    ...
    def test_miss_no_abilities(self):
        ...
        # set up attack
        attack = professions.WaveManAttackAction(self.attacker, self.target, "attack", self.initiative_action, self.context)
        attack.roll_skill()
...
class TestWaveManAttackSucceededListener(unittest.TestCase):
    ...
    def test_level_zero(self):
        ...
        attack = AttackAction(self.attacker, self.wave_man, "attack", self.initiative_action, self.context)
...
class TestWaveManTakeAttackActionEvent(unittest.TestCase):
    ...
    def test_level_zero(self):
        # set up an attack
        attack = professions.WaveManAttackAction(self.character, self.target, "attack", self.initiative_action, self.context)
        attack.set_skill_roll(30)

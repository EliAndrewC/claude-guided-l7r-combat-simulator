...
class AttackOptimizer:
    ...
    def initialize(self):
        ...
        self.action = self.subject.action_factory().get_attack_action(self.subject, self.theoretical_target, self.skill, self.initiative_action, self.context)
